        ...
        <Modal.Body>
          <div className="input-wrapper-modal">
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              <Form.Label><small>Check this <strong>{twoFaEmail?.slice(0, 1)}********{twoFaEmail?.slice(twoFaEmail?.length - 13, twoFaEmail.length)}</strong> inbox for Verification Code</small></Form.Label>
              <Form.Control
                type="text"
